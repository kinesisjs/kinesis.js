...
| `interpolation`           | `'linear' \| 'cubic' \| 'geodesic' \| 'smooth' \| 'none' \| 'adaptive' \| CustomInterpolator` | `'linear'`     | Interpolation behaviour                                                        |
...
| `playout`                 | `PlayoutOptions \| 'auto'`                                                                    | —              | Playout buffer for jittery feeds; pairs well with `[interpolation]="'smooth'"` |
