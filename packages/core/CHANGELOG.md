...
- [#18](https://github.com/kinesisjs/kinesis.js/pull/18) [`cbf8a56`](https://github.com/kinesisjs/kinesis.js/commit/cbf8a562caaf557e98882b11be6b94b7e447572f) Thanks [@Mu-As](https://github.com/Mu-As)! - Add `TrackerOptions.playout` — a per-vehicle queue that decouples display
